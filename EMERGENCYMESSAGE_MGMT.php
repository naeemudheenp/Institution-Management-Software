...
{
  echo "<center><form action='EMERGENCYMESSAGE_READ.php' method='post'>";
  echo "<center>You can send only verified message in emergency mode.<a href='verified.html'>Click here</a> to see verified messages. ";
