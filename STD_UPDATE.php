...
$RESULT_SET=mysql_fetch_array($RESULT_CHECK);
	...
	$SQL="UPDATE student SET name='".$name."',class='".$class."',gender='".$gender."',year='".$fyear."',rollno='".$Roll_no."',number='".$Mobile_no."',address='".$add."' WHERE admin_no='".$Ad_no."'";
	...
	<center>
	  <br><br><br>
	  <div>
	<form  class="login-card" name="STD_ADD" action="STD_UPDATE.php" method="post">
